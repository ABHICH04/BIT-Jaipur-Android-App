...
public class QuestionBank extends AppCompatActivity {
    ...
    private void getData() {
        dbref=reference.child("Question Bank").child(branchSelected).child(semSelected);
        dbref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter=new EbookAdapter(QuestionBank.this,list);
                ebookRcycler.setLayoutManager(new LinearLayoutManager(QuestionBank.this));
