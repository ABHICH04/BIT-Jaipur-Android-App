...
public class TimeTable extends AppCompatActivity {
    ...
    private void getData() {
        dbref=reference.child("Time Table").child(branchSelected).child(semSelected);
        dbref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter=new EbookAdapter(TimeTable.this,list);
                ebookRcycler.setLayoutManager(new LinearLayoutManager(TimeTable.this));
