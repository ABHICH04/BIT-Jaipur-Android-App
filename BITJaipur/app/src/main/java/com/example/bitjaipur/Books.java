...
public class Books extends AppCompatActivity {
    ...
    private void getData() {
        dbref=reference.child("Books-Notes").child(branchSelected).child(semSelected);
        dbref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter=new EbookAdapter(Books.this,list);
                ebookRcycler.setLayoutManager(new LinearLayoutManager(Books.this));
