...
public class Syllabus extends AppCompatActivity {
    ...
    private void getData() {
        dbref=reference.child("Syllabus").child(branchSelected).child(semSelected);
        dbref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter=new EbookAdapter(Syllabus.this,list);
                ebookRcycler.setLayoutManager(new LinearLayoutManager(Syllabus.this));
